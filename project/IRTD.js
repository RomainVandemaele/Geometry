function IRTD(center,proc) { //flat isocele right tranglei
  var WIDTH =  300;
  ...
  this.p3 = new Point(center.getX() - HEIGHT , center.getY() + HEIGHT/2 );
  this.c = center;
  ...
  //By unfolding with P2-P3 and P1-P2
   this.drawUnFolded = function() {
    ...
    for(j=this.move.length-1;j>=0;j--) {
      ...
      polygon.addPoint(this.move[j].getX() + 2*(this.p1.getX() - this.move[j].getX()), this.move[j].getY() );
    }
